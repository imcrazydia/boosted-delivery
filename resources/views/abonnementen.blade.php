...
<form action="{{ route('abonnementen.choice') }}" method="POST">
    ...
    <div class="abonnementen__cards">
        ...
        <div class="abonnementen__cards__content">
            ...
            <img src="{{URL::to('/')}}/img/icons/basic.png" class="abonnementen__cards__content__icon icon-basic"
                alt="card_icon" />
        </div>
        <!-- W Boosted -->
        <div class="abonnementen__cards__content">
            <img src="{{URL::to('/')}}/img/recommended.png" class="abonnementen__cards__content__recommended"
            ...
            <button type="submit" name="keuze" value="Weekelijkse - Boosted"
                class="abonnementen__cards__content__purchase">Bestel</button> <br />
            <img src="{{URL::to('/')}}/img/icons/boosted.png" class="abonnementen__cards__content__icon icon-boosted"
                alt="card_icon" />
        </div>
        <!-- W Extreme -->
        <div class="abonnementen__cards__content">
            ...
            <button type="submit" name="keuze" value="Weekelijkse - Extreme"
                class="abonnementen__cards__content__purchase">Bestel</button> <br />
            <img src="{{URL::to('/')}}/img/icons/extreme.png" class="abonnementen__cards__content__icon icon-extreme"
                alt="card_icon" />
        </div>
    </div>
</form>
