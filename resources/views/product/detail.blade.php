...
<div class="product-detail row">
  <div class="product-detail__list col-sm-8 col-lg-5 col-xl-3 offset-xl-1">
  ...
  <div class="product-detail__info col-lg-6">
    <div class="row">
      <img src="{{ asset('img/products/redbull.png') }}" alt="redbull" 
        class="product-detail__info__image 
              col-8 offset-3 col-sm-5 offset-sm-2 col-lg-2 offset-lg-0" 
      />
      <div class="product-detail__info__content col-10 offset-1 col-sm-5 offset-sm-0 col-md-6">
