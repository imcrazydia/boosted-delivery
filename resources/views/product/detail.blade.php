...
<div class="product-detail row">
  <div class="product-detail__list col-md-3 offset-md-1">
  ...
  <div class="product-detail__info col-md-6">
    <div class="row">
      <img src="{{ asset('img/products/redbull.png') }}" alt="redbull" class="product-detail__info__image col-md-6" />
      <div class="product-detail__info__content col-md-6">
